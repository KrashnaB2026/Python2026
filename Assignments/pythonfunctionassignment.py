# -*- coding: utf-8 -*-
"""pythonfunctionassignment.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_O1YM0VG5RMUO9C4w1KvdTZux-4MULqM
...
def sort_hyphen_words(s):
    ...
    return "-".join(words)    # Join back with hyphen

# Sample Input
sample = "green-red-yellow-black-white"

# Output
print(sort_hyphen_words(sample))  # Output: black-green-red-white-yellow
...
print(sample_function.__code__.co_nlocals)  # Output: 3
...
# Sort the list using lambda (based on second element - marks)
...
# Rearrange using lambda (positives first, then negatives)
